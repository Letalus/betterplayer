...
class BetterPlayer extends StatefulWidget {
  ...
  ///For [BetterPlayerDataSource] the network will always be network, even if the user selects the wrong one by accident
    ...
    BetterPlayerDataSource? betterPlayerDataSource,
      ...
      BetterPlayer(
        controller: BetterPlayerController(
          ...
          betterPlayerDataSource: betterPlayerDataSource?.copyWith(type: BetterPlayerDataSourceType.network) ??
